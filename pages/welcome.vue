  ...
  <div class="welcome_wrapper">
    ...
    <section class="history_section">
      ...
      <div class="playtime_transition_graph">
        ...
        <img v-if="$i18n.locale === 'ja'" src="~/static/20230731_TogoTVYouTube_stats_Ja.png" alt="">
      </div>
...
export default Vue.extend({
  head() {
    return {
      ...
      meta: [
        { hid: 'og:title', property: 'og:title', content: this.$i18n && this.$i18n.locale === "ja" ? `TogoTV ${this.$t('welcome_to')}` : `${this.$t('welcome_to')} TogoTV`},
