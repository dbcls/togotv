...
export default Vue.extend({
  async asyncData ( ) {
    let year_data = await axios.get(`http://54.95.237.130/api/yt_view/year`)
    let month_data = await axios.get(`http://54.95.237.130/api/yt_view/month`)
    let weekly_data = await axios.get(`http://54.95.237.130/api/yt_view/weekly`)
    return {
