...
export default Vue.extend({
  async asyncData ( ) {
    let year_data = await axios.get(`https://togotv-api.dbcls.jp/api/yt_view/year`)
    let month_data = await axios.get(`https://togotv-api.dbcls.jp/api/yt_view/month`)
    let weekly_data = await axios.get(`https://togotv-api.dbcls.jp/api/yt_view/weekly`)
    return {
